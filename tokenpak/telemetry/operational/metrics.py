...
class MetricsCollector:
    ...
    def to_prometheus_format(self) -> str:
        ...
        output.append(f'tokenpak_ingest_latency_seconds_bucket{{le="+Inf"}} {self.ingest_latency.count}')
        ...
        if self.rollup_last_run_timestamp:
            output.append('# HELP tokenpak_rollup_last_run_timestamp Last rollup job timestamp (unix)')
            output.append('# TYPE tokenpak_rollup_last_run_timestamp gauge')
            output.append(f'tokenpak_rollup_last_run_timestamp {int(self.rollup_last_run_timestamp)}')
            output.append('')
        ...
        output.append(f'tokenpak_rollup_duration_seconds_bucket{{le="+Inf"}} {self.rollup_duration.count}')
