...
class TestExtensionToLang:
    def test_py_maps_to_python(self):
        from tokenpak.processors.code_treesitter import EXTENSION_TO_LANG
...
class TestDetectLanguage:
    def test_py_extension(self):
        from tokenpak.processors.code_treesitter import _detect_language
...
class TestIsAvailable:
    def test_returns_bool(self):
        from tokenpak.processors.code_treesitter import is_available
        result = is_available()
    ...
    def test_reflects_ts_available_flag(self):
        import tokenpak.processors.code_treesitter as mod
...
class TestTextHelper:
    def test_decodes_node_text(self):
        from tokenpak.processors.code_treesitter import _text
        node = MagicMock()
...
class TestSigBeforeBody:
    ...
    def test_no_body_child_returns_full_text(self):
        from tokenpak.processors.code_treesitter import _sig_before_body
...
class TestFirstDocstring:
    def test_returns_none_for_empty_block(self):
        from tokenpak.processors.code_treesitter import _first_docstring
        block = MagicMock()
        block.children = []
...
class TestExtract:
    def test_returns_none_when_ts_unavailable(self):
        from tokenpak.processors.code_treesitter import extract
...
class TestTreeSitterProcessorInit:
    def test_instantiation_without_fallback(self):
        from tokenpak.processors.code_treesitter import TreeSitterProcessor
