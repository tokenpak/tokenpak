"""DEPRECATED — `tokenpak optimize` moved to tokenpak-paid (2026-04-21).

This module is a stub left behind by TPS-11. The real implementation
now lives in ``tokenpak_paid.commands._impls.optimize`` and is
installed via:
...
optimize`` to the real paid implementation when it is installed.
"""
...
_warnings.warn(
    "tokenpak.cli.commands.optimize: implementation moved to "
