"""tokenpak.orchestration.proxy_workflow — ProxyWorkflowAdapter
...
def _get_manager():
    ...
    if not WORKFLOW_TRACKING_ENABLED:
        return None
    from tokenpak.orchestration.workflow import get_manager
...
def start_proxy_workflow(
    ...
    try:
        from tokenpak.orchestration.workflow import template_steps
