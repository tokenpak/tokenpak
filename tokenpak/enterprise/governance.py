"""DEPRECATED — `tokenpak.enterprise.governance` moved to
`tokenpak_paid.enterprise.governance` (TPS-11, 2026-04-21).
...
_warnings.warn(
    "tokenpak.enterprise.governance: moved to tokenpak_paid.enterprise.governance "
...
def __getattr__(name):
    raise ImportError(
        f"tokenpak.enterprise.{governance}.{{name}} is not available in OSS. "
