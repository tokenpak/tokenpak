"""DEPRECATED — `tokenpak.enterprise.policy` moved to
`tokenpak_paid.enterprise.policy` (TPS-11, 2026-04-21).
...
_warnings.warn(
    "tokenpak.enterprise.policy: moved to tokenpak_paid.enterprise.policy "
...
def __getattr__(name):
    raise ImportError(
        f"tokenpak.enterprise.{policy}.{{name}} is not available in OSS. "
