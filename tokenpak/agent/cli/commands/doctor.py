...
DEFAULT_FLEET_CONFIG = {
    # Users with multi-host fleet deployments populate this list in
    # ~/.tokenpak/fleet.yaml. Empty by default — most users run a single
    # local proxy and do not need a fleet definition.
    "agents": []
}
