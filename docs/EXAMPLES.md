...
TOKENPAK_PORT=8766 TOKENPAK_MODE=hybrid tokenpak start
```
...
TOKENPAK_MODE=aggressive tokenpak start
```
...
| Hybrid mode | `TOKENPAK_MODE=hybrid tokenpak start` |
| Aggressive mode | `TOKENPAK_MODE=aggressive tokenpak start` |
| WebSocket port | `TOKENPAK_WS_PORT=8767 tokenpak start` (default: PROXY_PORT+1) |
| Disable compression | `TOKENPAK_MODE=strict tokenpak start` |
